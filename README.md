...
Fitness landscapes of simple regulatory genetic interactions show pervasive heterozygote advantage and stable polymorphism
  Adam H. Porter, Norman A. Johnson, and Alexander Y. Tulchinsky
  University of Massachusetts - Amherst

All are copywrite 2019-2024, by Adam Porter
...
and the optimization algorithm is described in Appendix 2.
...
allows the specification of the range of Popt values; by default it is the whole 0-1 range in steps of 0.005.  Inspect the first several lines of
...
have size=0, because they timed out. I export this file to my personal computer for further analysis.
After running the individual Popt cases below, I just concatenate those results manually using a copy/paste on my personal computer.
...
to rerun those cases individually.  It runs each value for the first TF allele's dosage site individually (there are 
...
below the global wBarMax.  Then, copy/paste the output into the file generated by concatFitnessOverdomFiles.sh.


I used Excel
to produce the the relevant figures in the manuscript (Fig. 5 and Appendix Fig. S2).
